# Fetch API · First Exercise

A minimal browser exercise that fetches a remote API response and writes it into the page.
...
- A console error handler.

> **Project notes:** The source uses a historical Code Institute SWAPI endpoint. Its availability is external to this repository; an unavailable service can leave the content area empty.
...
Repository maintained in [Sam O’Brien-Olinger’s GitHub account](https://github.com/SamOBrienOlinger). For a problem or suggested improvement, [open an issue](https://github.com/SamOBrienOlinger/API-CI-/issues) with the affected page or command, steps to reproduce, and expected behaviour.

[Back to top](#fetch-api--first-exercise)
